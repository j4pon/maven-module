...
public class ConnectOci {
	...
	private static String USER = "BNK";
	private static String PASS = "BNK";
	private static String EFT_POOL= "EFTRAC";
	...
	public static Connection openConnection() throws SQLException, UniversalConnectionPoolException {
		...
		return ConnectOci.getInstance().getConnection();
